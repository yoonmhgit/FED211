...
$(function () { ////// jQB ////////////////////////
    ...
    //________________________________[ 모바일 코드 ]________________________________________
    ...
    $(".sbtn").click(function(e){
        ...
        $(".mos").slideToggle(300,"easeInOutQuart");
    }); /////////////click//////////////



    // slideToggle(시간,이징,함수)
    // -> display:none 이면 slideDown
    // 아니면 slideUp을 실행함
    // 토글(toggle)은 두가지 기능을 겸하는 것을 말함
