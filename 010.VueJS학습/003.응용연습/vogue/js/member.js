...
$(function () { /////// jQB ///////////////////
    ...
    */
    $("input[type=text][id!=email2][class!=search],input[type=password]")
        .blur(function () {
            ...
            // 7. 이메일 입력창일경우 이메일 검사하기 //////
                ...
                // 이메일 뒷주소
                // 비?집:놀이동산;
                // 선택박스 value값이 free이면 직접입력(eml2) 값을 
                // 아니면 선택박스의 선택값을 넣어준다!
                console.log("결과" + comp);
    ...
    /////////////////////////////                             ////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////
    // 키보드관련 이벤트 종류 : keypress, keyup, keydown
    // 1. keypress : 키가 눌려졌을때
    ...
    seleml.change(function () {
        ...
        if (cv === "init") { // "선택해주세요" 선택시
            ...
            // 1. 직접입력창 보이기(fadeIn()+값초기화(val())+포커스주기(focus)
    ...
    ////////////////////////////////////////////////////////////////////////////////////////
    // 전체검사의 원리 :  
    // 전역변수 pass를 설정하여 true를 할당하고 검사 중간에 불통과 사유발생시 false로 변경!
    // 유효성검사 통과여부를 판단한다!
    // 검사방법 : 기존의 이벤트함수인 blur 이벤트를 강제 발생시킨다!
    ...
    $("#btnj").click(function (e) { // 서브밋버튼 클릭시
        ...
        if(pass){ 
            // 메시지 띄우기
            alert("회원가입을 축하드립니다");
            // 원래는 post방식으로 DB에 회원정보를 입력후 입력완료시의 위의 메시지를 띄워준다
        ...
        /* 
        location.href 는 뒤로가기시 history가 살아있어서 보안상위험 !
